...
export const SITE_NAME = "Netbask Systems Limited";
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || "https://netbask.com"; // Update with actual URL
export const TWITTER_HANDLE = "@NetbaskSystems";
...
export const SEODATA: Record<string, SEOConfig> = {
  default: {
    ...
    description:
      "Netbask Systems Limited provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.",
    keywords: [
  ...
  home: {
    ...
    description:
      "Innovate and grow with Netbask Systems Limited. We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.",
    keywords: [
  ...
  login: {
    ...
    description:
      "Access your Netbask Systems Limited client dashboard to track project progress, manage subscriptions, and collaborate with your dev team.",
    keywords: [
      "Client login",
      "Project tracking portal",
      "Netbask Systems Limited dashboard access",
    ],
  },
  register: {
    title: `Partner with Us | Join ${SITE_NAME}`,
    description:
      "Create an account to start your project journey with Netbask Systems Limited and access premium tech resources.",
    keywords: [
      "Get started with Netbask Systems Limited",
      "Project onboarding",
      "Digital partnership",
    ],
  },
