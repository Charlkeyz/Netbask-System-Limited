...
const RefundPolicy = () => {
  ...
  return (
    <div className="text-gray-600 space-y-6 text-xs sm:text-sm">
      <p>
        At Netbask Systems Limited, we strive for 100% accuracy in every order.
      ...
      <section>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-2">
          ...
          <li>
            ...
            our error, Netbask Systems Limited covers the return shipping. For
      ...
      <section>
        ...
        <p>
          At Netbask Systems Limited, we act as your dedicated procurement
