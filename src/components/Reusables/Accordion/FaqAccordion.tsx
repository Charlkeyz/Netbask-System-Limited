...
const faqItems: FaqAccordionItemProps[] = [
  {
    id: 1,
    title: "How does the Netbask Systems Limited importation process work?",
    description:
...

  {
    ...
    description:
      "After making a transfer to the Netbask Systems Limited corporate account, simply upload your transaction receipt and Session ID/Reference via the 'Verify Payment' button on your order page for instant admin reconciliation.",
  },
  ...
  },
  {
    ...
    description:
      "Yes. All electronic and mechanical products procured through Netbask Systems Limited carry a standard manufacturer’s warranty, which we help you facilitate in the event of a technical issue.",
  },
  {
    id: 8,
    title: "Is there a benefit to paying off my balance early?",
    description:
      "Yes, Netbask Systems Limited rewards financial discipline. Customers who complete their payments ahead of schedule may be eligible for discounts on future shipping fees or interest-free credit extensions.",
  },
  {
    id: 9,
